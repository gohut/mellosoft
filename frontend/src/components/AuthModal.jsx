      ...
      <div style={modalCardStyle} className="auth-modal-card">
        ...
        {activeModal === "login" && (
          <LoginForm
            ...
            onSuccess={() => {
              handleClose();
              const destination = intendedView && intendedView !== "login" && intendedView !== "signup" && intendedView !== "profile" ? intendedView : null;
              setIntendedView("home");
              if (destination) {
                setTimeout(() => navigateTo(destination), 0);
              }
            }}
          />
        )}
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} style={formStyle} noValidate>
        ...
        <button
          ...
          className="auth-google-btn hover-lift"
        >
          <GoogleIcon />
