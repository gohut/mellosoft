...
export const MATTRESS_PRODUCTS = [
  ...
  { id: "natura", slug: "natura", name: "Natura", category: "latex", categoryName: "Latex Mattress", tagline: "naturally comfortable, beautifully supportive", construction: "NATURAL LATEX", thicknessOptions: ["6 inch", "8 inch"], images: ["/images/mattresses/latex/natura.svg"], description: "Eco-certified natural Dunlop latex with organic cotton cover.", startingPrice: null, isNewArrival: true, newArrivalOrder: 4 },
  ...
  { id: "embrace", slug: "embrace", name: "Embrace", category: "memory-foam", categoryName: "Memory Foam Mattress", tagline: "comfort that gently surrounds you", construction: "MEMORY FOAM + HR", thicknessOptions: ["6 inch", "8 inch"], images: ["/images/mattresses/memory-foam/embrace.svg"], description: "Embracing contour foam cradles shoulders and hips for zero-pressure sleep.", startingPrice: null, isNewArrival: true, newArrivalOrder: 5 },
  ...
  { id: "celestial", slug: "celestial", name: "Celestial", category: "memory-foam", categoryName: "Memory Foam Mattress", tagline: "flagship comfort for truly luxurious sleep", construction: "PREMIUM MEMORY + SUPER SOFT + HR", thicknessOptions: ["8 inch", "10 inch"], images: ["/images/mattresses/memory-foam/celestial.svg"], description: "Flagship celestial memory mattress crafted with 4 layers of responsive foam.", startingPrice: null, isNewArrival: true, newArrivalOrder: 6 }
];
...
export const ACCESSORY_PRODUCTS = [
  ...
  { id: "cloud-contour", slug: "cloud-contour", name: "CloudContour", category: "memory-foam-pillow", categoryName: "Memory Foam Pillow", tagline: "adaptive neck support with cloud-like comfort", type: "Contour Memory Foam Pillow", firmness: "Medium", images: ["/images/accessories/memory-foam-pillows/cloud-contour.svg"], startingPrice: null, isNewArrival: true, newArrivalOrder: 7 },
  ...
  { id: "aqua-guard", slug: "aqua-guard", name: "AquaGuard", category: "mattress-protector", categoryName: "Mattress Protector", tagline: "waterproof protection for everyday use", type: "Waterproof Mattress Protector", sizes: ["78 x 36", "78 x 48", "78 x 60", "78 x 72"], images: ["/images/accessories/mattress-protectors/aqua-guard.svg"], startingPrice: null, isNewArrival: true, newArrivalOrder: 8 },
  ...
  // 10 BLANKETS / DUVETS
  { id: "cloud-duvet", slug: "cloud-duvet", name: "CloudDuvet", category: "blanket-duvet", categoryName: "Blanket / Duvet", tagline: "soft warmth with cloud-like comfort", type: "Microfiber Duvet", sizes: ["90 x 60", "100 x 90"], images: ["/images/accessories/blankets-duvets/cloud-duvet.svg"], startingPrice: null, isNewArrival: true, newArrivalOrder: 9 },
  ...
  { id: "flexi-bed", slug: "flexi-bed", name: "FlexiBed", category: "travel-bed", categoryName: "Travel Bed", tagline: "flexible folding comfort for compact spaces", type: "Multi-Fold Travel Bed", images: ["/images/accessories/travel-beds/flexi-bed.svg"], startingPrice: null, isNewArrival: true, newArrivalOrder: 10 }
];
