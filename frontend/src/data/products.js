export const MOCK_PRODUCTS = [
  {
    id: "classic-mattress",
    Product_Id: "PROD-001",
    Product_Name: "Mellosoft Classic Mattress",
    ...
    variants: [
      { Variant_Id: "VAR-TWIN-SOFT", SKU: "MEL-TWIN-SOFT", Size: "Twin", Firmness: "Soft", Actual_Price: 699, Stock: 10, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-TWIN-MED", SKU: "MEL-TWIN-MEDIUM", Size: "Twin", Firmness: "Medium", Actual_Price: 699, Stock: 15, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-TWIN-FIRM", SKU: "MEL-TWIN-FIRM", Size: "Twin", Firmness: "Firm", Actual_Price: 699, Stock: 8, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-FULL-SOFT", SKU: "MEL-FULL-SOFT", Size: "Full", Firmness: "Soft", Actual_Price: 799, Stock: 20, Threshold: 3, Status: "Active" },
      { Variant_Id: "VAR-FULL-MED", SKU: "MEL-FULL-MEDIUM", Size: "Full", Firmness: "Medium", Actual_Price: 799, Stock: 18, Threshold: 3, Status: "Active" },
      { Variant_Id: "VAR-FULL-FIRM", SKU: "MEL-FULL-FIRM", Size: "Full", Firmness: "Firm", Actual_Price: 799, Stock: 12, Threshold: 3, Status: "Active" },
      { Variant_Id: "VAR-QUEEN-SOFT", SKU: "MEL-QUEEN-SOFT", Size: "Queen", Firmness: "Soft", Actual_Price: 899, Stock: 14, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-QUEEN-MED", SKU: "MEL-QUEEN-MEDIUM", Size: "Queen", Firmness: "Medium", Actual_Price: 899, Stock: 16, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-QUEEN-FIRM", SKU: "MEL-QUEEN-FIRM", Size: "Queen", Firmness: "Firm", Actual_Price: 899, Stock: 9, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-KING-SOFT", SKU: "MEL-KING-SOFT", Size: "King", Firmness: "Soft", Actual_Price: 1099, Stock: 10, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-KING-MED", SKU: "MEL-KING-MEDIUM", Size: "King", Firmness: "Medium", Actual_Price: 1099, Stock: 12, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-KING-FIRM", SKU: "MEL-KING-FIRM", Size: "King", Firmness: "Firm", Actual_Price: 1099, Stock: 7, Threshold: 2, Status: "Active" }
    ],
    reviews: [
      {
        id: "r1",
  ...
  },
  {
    id: "luxe-hybrid",
    Product_Id: "PROD-002",
    Product_Name: "Mellosoft Luxe Hybrid",
    ...
    Actual_Price: 1499,
    discountPercent: 10,
    discountPrice: 1349.1,
    Discounted_Price: 1349.1,
    rating: 4.9,
    reviewCount: 96,
    badge: "Premium",
    ...
    variants: [
      { Variant_Id: "VAR-QUEEN-MED", SKU: "MEL-QUEEN-MEDIUM", Size: "Queen", Firmness: "Medium", Actual_Price: 1299, Stock: 30, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-QUEEN-FIRM", SKU: "MEL-QUEEN-FIRM", Size: "Queen", Firmness: "Firm", Actual_Price: 1299, Stock: 26, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-KING-MED", SKU: "MEL-KING-MEDIUM", Size: "King", Firmness: "Medium", Actual_Price: 1499, Stock: 22, Threshold: 2, Status: "Active" },
      { Variant_Id: "VAR-KING-FIRM", SKU: "MEL-KING-FIRM", Size: "King", Firmness: "Firm", Actual_Price: 1499, Stock: 18, Threshold: 2, Status: "Active" }
    ],
    reviews: [
      {
        id: "lh-r1",
  ...
  },
  {
    id: "latex-serene",
    Product_Id: "PROD-003",
    Product_Name: "Mellosoft Latex Serene",
    ...
    Actual_Price: 1199,
    discountPercent: 10,
    discountPrice: 1079.1,
    Discounted_Price: 1079.1,
    rating: 4.7,
    reviewCount: 68,
    badge: "Eco-Friendly",
  ...
  },
  {
    id: "ortho-support",
    Product_Id: "PROD-004",
    Product_Name: "Mellosoft Ortho Support",
  ...
  },
  {
    id: "ergo-air",
    Product_Id: "PROD-005",
    Product_Name: "Mellosoft Ergo Air",
  ...
  },
  {
    id: "luxury-pillow",
    Product_Id: "PROD-006",
    Product_Name: "Mellosoft Luxury Down Pillow",
  ...
  },
  {
    id: "oak-bedframe",
    Product_Id: "PROD-007",
    Product_Name: "Mellosoft Solid Oak Bed Frame",
  ...
  },
  {
    ...
    Product_Id: "PROD-008",
    Product_Name: "Mellosoft Organic Mattress Protector",
