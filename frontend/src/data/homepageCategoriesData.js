...
export const PRESET_IMAGE_OPTIONS = [
  { label: "Memory Foam Mattress", url: "/assets/categories/memory-foam.jpg" },
  { label: "Hybrid Mattress", url: "/assets/categories/hybrid.jpg" },
  { label: "Firm Mattress", url: "/assets/categories/firm.jpg" },
  { label: "Pillows", url: "/assets/categories/pillows.jpg" },
  { label: "Bed Frames", url: "/assets/categories/bed-frames.jpg" },
  { label: "Protectors", url: "/assets/categories/protectors.jpg" }
];
...
export const DEFAULT_HOMEPAGE_CATEGORIES = [
  ...
  },
  {
    ...
    href: "",
    firmness: "Hybrid",
    image: "/assets/categories/hybrid.jpg",
    color: "#FDE6D7",
    gradient: "linear-gradient(135deg, #FEEDE2 0%, #FCE0CF 50%, #F9CDAF 100%)",
    accentGlow: "rgba(253, 186, 116, 0.5)",
    ringColor: "rgba(234, 88, 12, 0.16)",
  ...
  },
  {
    ...
    href: "",
    firmness: "Firm",
    image: "/assets/categories/firm.jpg",
    color: "#E0F5EB",
    gradient: "linear-gradient(135deg, #E8F8F0 0%, #D8F2E4 50%, #BFEBD3 100%)",
    accentGlow: "rgba(134, 239, 172, 0.5)",
    ringColor: "rgba(22, 163, 74, 0.16)",
